$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "החתונה של דין וקים",

            // Event start date
            start: new Date('Dec 27, 2023 19:30'),
            ...
            end: new Date('Dec 28, 2023 02:30'),

            // Event Address
            address: 'האחוזה, בית חנן',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>רק רגע!</strong> אנחנו שומרים את הפרטים'));
